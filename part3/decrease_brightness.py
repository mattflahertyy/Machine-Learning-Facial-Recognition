...
class ImageProcessor:
    def __init__(self, directory, brightness_threshold=137, brightness_decrease_factor=0.95):
    ...
    def decrease_brightness(self, image, factor=0.98):
        if image.mode != 'RGB':
...
if __name__ == "__main__":
    directory = "data_augmentation/black/male/"
