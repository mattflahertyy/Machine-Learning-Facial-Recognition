...
class FacialExpressionCNN(nn.Module):
    def __init__(self):
        ...
        # four fully connected layers and a dropout layer to prevent overfitting
        # outputs 4 classes
        # kernel size is 5x5
...
def train_model(model, train_loader, val_loader, criterion, optimizer, num_epochs=15, patience=1):
    ...
    for epoch in range(num_epochs):
     ...
     #train loop over the training dataset
        ...
        if val_loss < best_loss:
            ...
            torch.save(model.state_dict(), 'variant_2.pth')
        else:
