...
IMAGE_PATH = '../data2/angry/angry__61.png'
IMAGE_LABEL = 0
...
# DataLoader
single_image_dataset = SingleImageDataset(IMAGE_PATH, IMAGE_LABEL, transform=transform)
...
# evaluate all models
labels, main_preds = evaluate_model(main_model, single_image_loader)
_, variant1_preds = evaluate_model(variant1_model, single_image_loader)
_, variant2_preds = evaluate_model(variant2_model, single_image_loader)
